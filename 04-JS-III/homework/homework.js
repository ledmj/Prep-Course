...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  return palabras.reduce((acc, element) => acc + ' ' + element);
}
...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce((acc, element) => acc + element);
}
...
function mesesDelAño(array) {
  ...
  return array.filter(element => element == 'Enero' || element == 'Marzo' || element == 'Noviembre');
}
